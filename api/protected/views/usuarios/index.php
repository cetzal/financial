                ...
                <div class="span12" style="color:#fff;">
                    <div class="span6" style="background-color:#162e5c;">
                        ...
                        <div class="span8">
                            ...
                            <ul>
                                <li>
                                    <a <?php echo 'href="'.CController::createurl('clientes/promocion').'"'; ?>>
                                        Clientes
                                    </a>                                    
                                </li>
                                <li>
                                    <a <?php echo 'href="'.CController::createurl('muro/index').'"'; ?>>
                                        Muro
                                    </a>                                    
                                </li>
                    ...
                    <div class="span6" style="background-color:#162e5c;">
                        ...
                        <div class="span8">
                            ...
                            <ul>
                                <li>
                                    <a <?php echo 'href="'.CController::createurl('cotizador/index').'"'; ?>>
                                        Nuevo
                                    </a>                                        
                                </li>
                                <li>
                                    <a <?php echo 'href="'.CController::createurl('clientes/index').'"'; ?>>
                                        Listado
                                    </a>                                    
                                </li>                       
                            </ul>
