                ...
                <div class="span12" style="color:#fff;">
                    <div class="span6" style="background-color:#162e5c;">
                        ...
                        <div class="span8">
                            ...
                            <ul>
                                <li>
                                    <a <?php echo 'href="'.CController::createurl('reportes/tareasAtrasadas').'"'; ?> >
                                        Tareas atrasados
                                    </a>                                    
                                </li>
                                <li>
                                    <a <?php echo 'href="'.CController::createurl('reportes/tareasFuturas').'"'; ?>>
                                        Proximas tareas
                                    </a>                                    
                                </li>
                                <li>
                                    <a <?php echo 'href="'.CController::createurl('reportes/tareaPeople').'"'; ?>>
