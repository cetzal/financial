...
class Bootstrap extends CApplicationComponent
{
	...
	const PLUGIN_SELECTPICKER='selectpicker';
	...
	/**
	 * Registers the Bootstrap-select plugin.
	 *
	 * @param null $selector
	 * @param array $options
	 * @deprecated 3.0.0
	 */
	public function registerSelectPicker($selector = null, $options = array())
	{
		$this->registerPlugin(self::PLUGIN_SELECTPICKERR, $selector, $options);
	}
