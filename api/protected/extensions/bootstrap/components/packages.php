...
return array(
	...
	'selectpicker' => array(
			'baseUrl' => $this->getAssetsUrl() . '/bootstrap-select',
			'js' => array($this->minify ? 'js/bootstrap-select.min.js' : 'js/bootstrap-select.js'),
			'css' => array($this->minify ? 'css/bootstrap-select.min.css' : 'css/bootstrap-select.css'),
			'depends' => array('bootstrap.js')
	),
);
