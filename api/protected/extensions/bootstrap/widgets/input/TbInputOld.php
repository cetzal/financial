...
abstract class TbInput extends CInputWidget
{
	...
	const TYPE_BOOTSTRAPSELECT = 'bootstrapselect';
	...
	public function run()
	{
		switch ($this->type) {
			...
			case self::TYPE_BOOTSTRAPSELECT:
				$this->bootstrapselectField();
				break;
	 ...
	 *
	 * Renders a bootstrapselect field.
	 *
	 * @return mixed
	 */
	abstract protected function bootstrapselectField();
