...
class TbActiveForm extends CActiveForm
{
	 ...
	 * TODO: WTF is a input of type `Select2`? Rename it to something more meaningful!
	 *
	 * Renders a bootstrapSelect field row
	 *
	 * @param CModel $model
	 * @param string $attribute
	 * @param array $htmlOptions
	 ...
	 * @return string
	 */
	public function bootstrapSelectRow($model, $attribute, $data, $htmlOptions = array())
	{
		return $this->inputRow(TbInput::TYPE_BOOTSTRAPSELECT, $model, $attribute, $data, $htmlOptions);
	}
